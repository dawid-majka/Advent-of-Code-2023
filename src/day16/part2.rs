...
pub fn solve(input: &str) -> usize {
    ...
    // Up row
    for x in 0..x_len {
        let start_tile = &grid[0][x];
        let from = ComingFrom::Up;
    ...
    // Down row
    for x in 0..x_len {
        let start_tile = &grid[y_len - 1][x];
        let from = ComingFrom::Down;
    ...
    // Down row
    for y in 0..y_len {
        let start_tile = &grid[y][x_len - 1];
        let from = ComingFrom::Right;
